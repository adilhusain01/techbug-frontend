const Founders = () => {
  return (
    <div
      className={`mt-[-1rem] bg-white self-stretch flex flex-col items-center justify-center px-[1rem] md:px-[3rem] lg:px-[7.5rem] py-[2.5rem] box-border gap-[5rem] text-black`}
    >
