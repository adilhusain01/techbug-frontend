...
const HeroSectionButton = () => {
  return (
    // <AnimatedSection>
    <button
      className={`cursor-pointer py-0 md:py-[0.125rem] px-[0.25rem] bg-[transparent] md:w-[12.75rem] rounded-37xl box-border flex flex-row items-center justify-start gap-[0.75rem] border-[2px] border-solid border-[#F1CB47] mx-auto`}
    >
      <img
