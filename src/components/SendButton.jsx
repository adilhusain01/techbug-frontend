...
const SendButton = ({ color }) => {
  return (
    <button
      type='submit'
      className={`mt-8 cursor-pointer py-0 md:py-[0.125rem] px-[0.25rem] bg-[transparent] w-[12rem] md:w-[16rem] rounded-37xl box-border flex flex-row items-center justify-start gap-[0.75rem] border-[1px] border-solid border-goldenrod-100`}
    >
      <img
