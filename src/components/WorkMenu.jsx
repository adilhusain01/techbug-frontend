...
function WorkMenu() {
  ...
  return (
    <>
      <section className='self-stretch flex flex-row items-start justify-start box-border max-w-full text-left text-[6rem] text-black font-plus-jakarta-sans'>
      ...
      <section className='w-full self-stretch [background:linear-gradient(180deg,_#ffe9dd,_#fff)] overflow-hidden flex flex-col items-center justify-center box-border max-w-full'>
        <div className='w-full py-[8rem] self-stretch grid grid-cols-2 justify-items-center px-[5.5rem] box-border max-w-full gap-[8rem] lg:pt-[2.75rem] lg:pb-[2.75rem] lg:box-border'>
