  ...
  return (
    <>
      <section className='self-stretch flex flex-row items-start justify-start box-border max-w-full text-left text-[6rem] text-black font-plus-jakarta-sans mq450:pb-[2.125rem] mq450:box-border'>
        <div className='py-[10rem] flex-1 flex flex-row items-start justify-between pl-[5.5rem] pr-[4.812rem] box-border max-w-full gap-[1.25rem] mq450:pl-[1.25rem] mq450:box-border mq825:pl-[2.75rem] mq825:pr-[2.375rem] mq825:box-border mq1400:flex-wrap'>
