...
function Team() {
  return (
    <section className='mt-[-0.5rem] py-[5rem] lg:py-[6rem] bg-white w-full flex flex-col items-center justify-between shrink-0'>
      <AnimatedSection>
      ...
      <div className='mt-[1rem] md:mt-[2rem] shrink-0 flex flex-row items-start justify-between gap-[0.7rem] md:gap-[1rem] lg:gap-[12rem] z-[2]'>
        <AnimatedSection>
          <img
