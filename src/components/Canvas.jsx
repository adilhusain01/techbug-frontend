...
const Canvas = () => {
  return (
    ...
    >
      ...
      <AnimatedSection>
        <h3 className='w-[100%] md:w-[90%] lg:w-[75%] m-0 text-[1.25rem] md:text-[2rem] lg:text-[4rem] relative leading-[1.25rem] md:leading-[2rem] lg:leading-[4rem] text-white font-semibold text-center mx-auto'>
