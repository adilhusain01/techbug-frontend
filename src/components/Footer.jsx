  ...
  return (
    ...
    >
      <div className='m-0 p-0 flex flex-col items-start justify-start gap-[0.5rem] lg:gap-[1.25rem]'>
        <AnimatedSection>
          <img
            className='h-auto w-full  max-w-[6rem] md:max-w-[8rem] lg:max-w-[10rem] object-cover relative overflow-hidden shrink-0'
            loading='lazy'
            alt='logo'
            src='https://res.cloudinary.com/djxuqljgr/image/upload/f_auto,q_auto/b9loymbrksijbqi80ypt'
          />
        </AnimatedSection>
