...
const HeroContent = () => {
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-center max-w-full text-center text-[4.375rem] text-white font-plus-jakarta-sans`}
    >
      <div className='w-[65.875rem] flex flex-col items-start justify-start gap-[2rem] max-w-full mq800:gap-[1rem]'>
        ...
        <div className='self-stretch flex flex-row items-start justify-start py-[0rem] px-[4.875rem] box-border max-w-full text-[1.875rem] mq1125:pl-[2.438rem] mq1125:pr-[2.438rem] mq1125:box-border'>
          <h2 className='m-0 flex-1 relative text-inherit leading-[149%] font-medium font-inherit inline-block max-w-full mq800:text-[1.5rem] mq800:leading-[2.25rem] mq450:text-[1.125rem] mq450:leading-[1.688rem]'>
