  ...
  return (
    <div>
      ...
      >
        ...
        <article className='flex-1 rounded-11xl [background:linear-gradient(191.03deg,_#1e1e1e_27.46%,_#5f5f5f)] box-border flex flex-col items-end justify-start p-[4rem] gap-[0.5rem] max-w-full border-[1px] border-solid border-stroke-1 mq800:pt-[1.688rem] mq800:pb-[1.563rem] mq800:box-border'>
          <div className='self-stretch flex flex-row items-start justify-center py-[0rem] pr-[0rem]'>
            <img
              className='h-[21.5rem] w-[17.5rem] relative'
              loading='lazy'
