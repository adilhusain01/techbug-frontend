const Greeting = () => {
  return (
    <div
      className={`shrink-0 flex flex-row items-center justify-center box-border relative gap-[0.3rem] md:gap-[1rem] lg:gap-[2rem] w-full overflow-hidden text-[3rem] md:text-[4rem] lg:text-[6rem] text-white`}
